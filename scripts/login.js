...
function handleLoginFormSubmit(event) {
    ...
    axios.post('https://rinokey.com/restAuth.php', data)
      .then(response => {
        ...
        if (response.data.success) {
          ...
          localStorage.setItem('ocultarContenidoAxa', JSON.stringify(response.data.ocultar));
          localStorage.setItem('listaMostrarCompañias', JSON.stringify(response.data.aseguradoras))
      ...
      .catch(error => {
        ...
        alert('Error durante la autenticación, por favor verifica tu conexión.');
      });
  }
